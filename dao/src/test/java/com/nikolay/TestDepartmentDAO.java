...
public class TestDepartmentDAO {
    ...
    public void testSaveDepartment(){
        Department department = new Department(1L, "java", new BigDecimal(200), Currency.getInstance("USD"));
    ...
    public void testUpdateDepartment(){
        Department department = departmentDAO.getDepartmentById(1L);
        Department newDepartment = new Department(1L, "sql", BigDecimal.valueOf(200), Currency.getInstance("USD"));
